...
export default function Hero() {
    ...
    const textPosition = useTransform(scrollYProgress, [0, 0.5], ["0%", "50%"]) // Move towards center-ish if needed, or just let scale do it

    return (
        <section ref={containerRef} id="home" className="relative h-[250vh]">
                    ...
                    <div className="text-left z-10 relative">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-bold font-heading text-white mb-6 leading-tight">
                                <motion.span style={{ opacity }}>Ignite Your <br /></motion.span>
                                <motion.span
                                    style={{ scale }}
                                    className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-accent inline-block origin-left"
                                >
                                    Potential
                                </motion.span>
                            </h1>
                            ...
                            <motion.div style={{ opacity }} className="flex flex-wrap gap-4">
